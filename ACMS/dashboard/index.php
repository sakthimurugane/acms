        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                        ...
                        <div class="col-md-5">
                            <div class="header-rightside">
                                <ul class="list-inline header-top pull-right">
                                    <li class="hidden-xs"><a href="../controllers/logoutcontroller.php" class="add-project" data-toggle="modal" data-target="#add_project">Log out</a></li>
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../images/user-pic.jpg" alt="user">
                                            <b class="caret"></b></a>
                ...
                <div class="user-dashboard">
                    <h1>Hello, <?php echo $_SESSION['SESS_FIRST_NAME']?></h1>
                    <div class="row">
