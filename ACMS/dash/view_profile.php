...
<div class="content-wrapper">
	...
	<div class="row panel panel-success" style="margin-top:2%;margin:10px;padding:20px;">
           <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-16 col-md-16"><i class="fa fa-users"></i> View GST Profiles</div>
                            ...
                            <a href="student-delete.php?sid=1&amp;id=68" class="btn btn-success btn-sm btn-default"><i class="fa fa-trash-o fa-1x"></i></a>
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item"><a data-toggle="tab" href="#Contact" class=" nav-link text-success"><i class="fa fa-bookmark-o"></i> Contact Info</a></li>
                                        <li class="nav-item"><a data-toggle="tab" href="#Address" class=" nav-link text-success"><i class="fa fa-home"></i> Address</a></li>
                                        <li class="nav-item"><a data-toggle="tab" href="#General" class=" nav-link text-success"><i class="fa fa-info"></i> General Info</a></li>	
                                    </ul>
        ...
        Gorakhpur, Utter Pradesh, India<br>
                                        ...
                                        <div id="Contact" class="tab-pane container">
                                            <div class="table-responsive panel">
                                                <table class="table">
                                                    <tbody>
                                        ...
                                        <div id="General" class="tab-pane container">
                                            <div class="table-responsive panel">
                                                <table class="table">
                                                    <tbody>
                                                                <tr>
